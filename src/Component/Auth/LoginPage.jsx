...
const LoginPage = () => {
  ...
  return (
    ...
    initial={variants.initial}
      ...
      exit={variants.exit}
    >
      <div className="flex flex-wrap w-full h-screen text-white bg-black">
        <div className="flex flex-col w-full md:w-1/2">
          ...
          <div className="flex flex-col justify-center px-8 pt-8 my-auto md:justify-start md:pt-0 md:px-24 lg:px-32">
            ...
            >
              ...
              <div className="flex flex-col pt-4 mb-4">
                ...
                <label className="label px-4 py-2  ">
                  <span className="label-text text-gray-300">Use Default Credentials</span>
                  <input
                    type="checkbox"
            ...
            <div className="pt-4 pb-4 text-gray-300 text-center">
              <p>
