...
const UserProfile = ({ setOpenProfile, openProfile }) => {
  ...
  return (
      ...
      >
        <div className="md:p-8 p-6  w-96 relative bg-[#1f2229] rounded">
          <div className="absolute p-1 right-0 top-0">
            <button
              onClick={() => setOpenProfile(!openProfile)}
              className="btn hover:bg-[#3abff8] text-white  btn-circle btn-sm"
            >
              <svg
          ...
          <div className="md:mb-8 mb-2 w-full space-y-2">
